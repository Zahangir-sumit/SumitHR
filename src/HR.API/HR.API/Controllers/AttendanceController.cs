...
namespace HR.API.Controllers
{
    public class AttendanceController : BaseController
    {
        ...
        public AttendanceController(IUnitOfWork unitOfWork, ApplicationDbContext context, ILogger<AttendanceController> logger) : base(unitOfWork)
        {
            _context = context;
            _logger = logger;
        }
        ...
        [HttpPost]
        [Route("MonthlyAttendanceProcess")]
